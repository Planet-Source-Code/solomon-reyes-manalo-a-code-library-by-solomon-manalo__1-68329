...
Begin VB.Form frmCategory 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin CodeLibrary.lvButtons_H cmdNew 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmCategory.frx":2E40
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmCategory.frx":33DA
      End
      Begin CodeLibrary.lvButtons_H cmdRename 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmCategory.frx":353C
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmCategory.frx":3AD6
      End
      Begin CodeLibrary.lvButtons_H cmdRemove 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmCategory.frx":3C38
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmCategory.frx":41D2
      End
...
Call cboLanguage_Change
With Me.cboLanguage
     If .Text = "" Or .Text = "Language List" Then
