...
Begin VB.Form frmSaveCode 
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   6450
      Width           =   2265
      Begin CodeLibrary.lvButtons_H lvSave 
         Height          =   375
         Left            =   150
         TabIndex        =   1
         Top             =   180
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmSaveCode.frx":16B6
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmSaveCode.frx":1A50
      End
      Begin CodeLibrary.lvButtons_H lvCancel 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmSaveCode.frx":1BB2
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmSaveCode.frx":1F4C
      End
   End
...
If fso.FileExists(DATAPATH & c) = True Then
   ...
   If Msg = vbYes Then
      Call SaveFileAs(DATAPATH, c, mdiMain.ActiveForm.txtdoc.TextRTF)
