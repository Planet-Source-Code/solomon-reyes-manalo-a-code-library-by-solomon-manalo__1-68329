...
Begin VB.Form frmLanguage 
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   1500
      Width           =   1605
      Begin CodeLibrary.lvButtons_H cmdNew 
         Height          =   375
         Left            =   150
         TabIndex        =   3
         Top             =   240
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmLanguage.frx":038A
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmLanguage.frx":0724
      End
      Begin CodeLibrary.lvButtons_H cmdRename 
         Height          =   375
         Left            =   150
         TabIndex        =   4
         Top             =   720
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmLanguage.frx":0886
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmLanguage.frx":0C20
      End
      Begin CodeLibrary.lvButtons_H cmdRemove 
         Height          =   375
         Left            =   150
         TabIndex        =   5
         Top             =   1200
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "frmLanguage.frx":0D82
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmLanguage.frx":111C
      End
      Begin CodeLibrary.lvButtons_H lvButtons_H4 
         Height          =   375
         Left            =   150
         TabIndex        =   6
         Top             =   2700
         ...
         cBack           =   -2147483633
         mPointer        =   99
         mIcon           =   "frmLanguage.frx":127E
      End
      Begin CodeLibrary.lvButtons_H lvRefresh 
         Height          =   375
         Left            =   150
         TabIndex        =   16
         Top             =   2250
   ...
   Begin MSComctlLib.ListView lvLanguage 
      ...
      Appearance      =   0
      MousePointer    =   99
      MouseIcon       =   "frmLanguage.frx":2926
      NumItems        =   0
   End
